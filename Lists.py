...
popped_item = names.pop() #no arugment so we pop the last index by default
print(popped_item)
print(names)
...
movies = ["gladiator", "save the last dance", "thorn", "xman", "blade"]
#append (add to the end)
movies.append ("Gijoe")
print (movies)
# insert 
movies.insert (3, "Bride of Chucky")
print(movies)
#index 
movies[2] = "The Wave "
print(movies)
...
print(guest_numbers is guest_numbers2) # True because guest_number2 points to the variable of guest_numbers, giv
print(guest_numbers is not guest_numbers3) #False because the variables 
